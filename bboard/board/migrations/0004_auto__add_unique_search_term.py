...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Search', fields ['term']
        db.create_unique('board_search', ['term'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Search', fields ['term']
        db.delete_unique('board_search', ['term'])
    ...
    models = {
        ...
        'board.search': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'term': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '200'}),
